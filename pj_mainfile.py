...
# import required functions from module
from cbfu_modules import execute_fortran, imaging_grid, imaging_and_movie, organize_files, segment_plots
...
plt_title = "$\\beta_R: "+ bR + "\\; \\alpha_0: "+a0 + "\\; \\Delta\\alpha: "+a1 + "\\;\\alpha_{speed}: "+sa + "\\; configuration: "+fortran_script + "$"
nbfu = int(nx) * int(nx)

# define the segment where the plot is needed
start = 0
stop = 1000
segment_plots(file_prefix, "A", nbfu, ws, start, stop, plt_title)
